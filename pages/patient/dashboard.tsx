...
export default function Page() {
  ...
  return (
    <PatientLayout>
      ...
      {/* Veiw boxes */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 py-7 px-6 md:grid-cols-1">
        ...
        <Card>
          <CardContent className="flex items-center space-x-4 p-4">
            ...
            <div>
              ...
              <Button variant="outline" className="mt-2"><Link href="/patient/view-record">View</Link></Button>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="flex items-center space-x-4 p-4">
            ...
            <div>
              ...
              <Button variant="outline" className="mt-2"><Link href="/patient/payment-history">View</Link></Button>
            </div>
          </CardContent>
        </Card>
