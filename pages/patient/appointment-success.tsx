...
const AppointmentSuccessPage = () => {
  ...
  const { date, time, doctor, patient, reason, contactEmail, status } =
        ...
        <div className="flex flex-col items-center justify-center p-4 w-[90%] md:w-[100%] mx-auto">
          <div className="flex flex-col items-center mb-6">
            ...
            <h1 className="text-2xl font-bold text-center">
              Your <span className="text-primary">Appointment Request</span> has been Successfully
              Booked!
            </h1>
            <p className="mt-2 text-base text-muted-foreground text-center">
              We will be in touch shortly to confirm your appointment. If you which to cancel this
              Appointment cantact the support center using the complaint form{" "}
            </p>
          </div>
