     ...
     useTheme();
      ...
      const commonInjuries = [
        ...
        },
        {
          ...
          treatment: "Cool the burn with running water, cover with a sterile dressing, and seek medical attention.",
        },
        {
          name: "Fractures",
                ...
                <div className="bg-background rounded-2xl shadow-lg p-12">
                  ...
                  <ul className=" pl-8 space-y-4">
                    {["The injury or condition is severe or life-threatening", 
                     ...
                     "Suspected fractures or serious injuries"].map((item, index) => (
