...
const EmergencyPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background w-full">
      ...
      <div className="w-full px-4 py-12 sm:px-6 lg:px-8 mt-16">
        <h1 className={`text-4xl font-bold text-primary text-center`}>Emergency Care</h1>
        ...
        <div className="grid grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-6 mb-12">
          {emergencyContacts.map((contact) => (
            <div key={contact.name} className="bg-background-800 p-6 rounded-lg shadow-md">
              <div className="flex items-center mb-4">
                <contact.icon className={`h-12 w-12 mr-4 text-red-500`} aria-hidden="true" />
                <h3 className={`text-xl font-semibold text-foreground`}>{contact.name}</h3>
              </div>
              <p className={`text-2xl font-bold text-foreground mb-4`}>{contact.number}</p>
              <Button
                variant="outline"
        ...
        <div className="bg-background rounded-lg shadow-md p-8 mb-12">
          <h2 className={`text-2xl font-bold mb-6 text-center text-primary`}>Emergency Services</h2>
          <div className="grid grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-6">
            <div className="p-4 border rounded-lg">
              <h3 className={`text-xl font-semibold text-foreground mb-2`}>Ambulance Dispatch</h3>
              <p className={`textforeground`}>
                24/7 ambulance dispatch service for critical emergencies
              </p>
            </div>
            <div className="p-4 border rounded-lg">
              <h3 className={`text-xl font-semibold text-foreground`}>Emergency Room Access</h3>
              <p className={`text-foreground`}>Direct access to our emergency room facilities</p>
            </div>
            <div className="p-4 border rounded-lg">
              <h3 className={`text-xl font-semibold text-foreground mb-2`}>Emergency Triage</h3>
              <p className={`text-foreground`}>
                Immediate triage and prioritization of critical cases
              </p>
            </div>
            <div className="p-4 border rounded-lg">
              <h3 className={`text-xl font-semibold text-foreground mb-2`}>Critical Care Unit</h3>
              <p
                className={`text-fore
                    ground`}>
        ...
        <div className="bg-background rounded-lg shadow-md p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Button
              variant="outline"
              className="w-full flex items-center justify-center hover:bg-primary"
