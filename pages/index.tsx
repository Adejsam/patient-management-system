...
export default function HomePage() {
  ...
  return (
    <main>
      ...
      <section className="flex gap-2 md:flex-col sm:flex-col w-full h-screen">
        <div className="flex flex-col justify-center items-left mt-7 h-full w-1/2 pl-10 md:px-10 sm:px-5 md:w-full sm:w-full ">
          <h1
            className={`text-5xl md:text-center sm:text-center font-bold mb-4 ${
              resolvedTheme === "dark" ? "text-white" : "text-black"
            }`}>
            Welcome 👋 to <span className="text-primary">Your Patient Management System</span>
          </h1>
          <p
            className={`text-lg mb-4 md:text-center sm:text-center ${
              resolvedTheme === "dark" ? "text-white" : "text-black"
            }`}>
          ...
          <button className="mr-auto md:mx-auto sm:mx-auto px-4 py-2 bg-primary text-primary-foreground hover:bg-primary/80 rounded-md ">
        ...
        <div className="w-1/2 h-full px-10 md:w-full sm:w-full">
          <Image
            src={HeroImage}
            alt="Hero Image"
            width={1000}
            height={1000}
            priority={true}
            className="object-cover h-full md:w-full sm:w-full"
          />
        </div>
      </section>
        ...
        <div className="py-10 sm:py-32">
          <div className="mx-auto max-w-7xl pb-6 lg:px-8">
            <div
              ...
              <p className="mt-2 text-4xl font-semibold tracking-tight text-pretty text-primary md:text-center sm:text-center sm:text-5xl lg:text-balance">
                Everything you need to manage your patients
              </p>
              <p
                className={`mt-6 text-lg/8 md:text-center sm:text-center ${
            ...
            <div className="mx-auto mt-14 max-w-[100%] sm:mt-20 md:px-10 mb-[100px]">
              <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16 md:mx-auto sm:mx-auto">
      ...
      <section className=" px-12 mb-[100px]">
        <h1 className="text-4xl text-center font-semibold tracking-tight text-pretty text-primary sm:text-5xl lg:text-balance md:mb-[50px] sm:mb-[50px]">
          Discover What We Offer
        </h1>
        <div className="flex gap-5 w-full md:flex-col sm:flex-col">
          <div className="w-1/2 flex flex-col justify-center h-[auto] md:w-full sm:w-full">
            <h2
              className={`text-2xl font-bold md:text-center sm:text-center ${
                resolvedTheme === "dark" ? "text-white" : "text-gray-900"
              }`}>
              Appointment Scheduling
            </h2>
            <p
              className={`my-5 w-[85%] md:w-full  sm:w-full text-base/7 md:text-center sm:text-center ${
                resolvedTheme === "dark" ? "text-gray-300" : "text-gray-600"
              }`}>
            ...
            <div className="w-[20%] md:mx-auto sm:mx-auto">
          ...
          <div className="w-1/2 h-[auto] md:w-full sm:w-full">
            <Image
        ...
        <div className="my-[50px] flex gap-5 w-full md:flex-col sm:flex-col md:mb-[150px]">
          <div className="w-1/2 flex flex-col justify-center h-[auto] md:w-full sm:w-full">
            <h2
              className={`text-2xl font-bold md:text-center sm:text-center ${
                resolvedTheme === "dark" ? "text-white" : "text-gray-900"
