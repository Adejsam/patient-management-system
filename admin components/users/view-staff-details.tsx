    ...
    switch (staff.role) {
      case "doctor":
        return (
          <div>
            <p>
              <strong>Medical License Number:</strong> {staff.licenseNumber}
            </p>
            <p>
              {" "}
            ...
            <p>
              {" "}
              <strong>Years of Experience:</strong> {staff.yearsExperience}
            </p>
            <p>
              {" "}
              <strong>About:</strong> {staff.about}
            </p>
          </div>
        );
      case "pharmacist":
        return (
          <p>
            {" "}
            <strong>Pharmacy License Number:</strong> {staff.licenseNumber}
          </p>
        );
      default:
        return null;
            ...
            <p className="mx-auto">
              ...
              {staff?.profilePicture ? (
                <Image
                  ...
                  src={
                    staff.profilePicture
                      ? URL.createObjectURL(staff.profilePicture)
                      : "/default-profile.png"
                  }
                  alt="Staff Photo"
